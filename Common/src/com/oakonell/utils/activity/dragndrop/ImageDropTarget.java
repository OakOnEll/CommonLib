...
public class ImageDropTarget extends ImageView implements DropTarget {

	private DragController mDragController;
	private com.oakonell.utils.activity.dragndrop.OnDropListener dropListener;
	private com.oakonell.utils.activity.dragndrop.OnDragListener dragListener;
	...
	public void onDrop(DragSource source, int x, int y, int xOffset,
		...
		if (isEnabled()) {
			if (dropListener != null) {
				dropListener.onDrop(this, source, x, y, xOffset, yOffset,
						dragView, dragInfo);
			}
		}
	...
	public void setOnDropListener(
			com.oakonell.utils.activity.dragndrop.OnDropListener listener) {
		dropListener = listener;
	}

	public void setOnDragListener(
			com.oakonell.utils.activity.dragndrop.OnDragListener listener) {
	...
	public void onDragEnter(DragSource source, int x, int y, int xOffset,
		...
		if (isEnabled()) {
			...
			if (dragListener != null) {
				dragListener.onDragEnter(this, source, x, y, xOffset, yOffset,
						dragView, dragInfo);
			}
		}
	}
	...
	public void onDragOver(DragSource source, int x, int y, int xOffset,
			int yOffset, DragView dragView, Object dragInfo) {
		if (dragListener != null) {
			dragListener.onDragOver(this, source, x, y, xOffset, yOffset,
					dragView, dragInfo);
		}
	}
	...
	public void onDragExit(DragSource source, int x, int y, int xOffset,
		...
		if (isEnabled()) {
			setImageLevel(1);
			if (dragListener != null) {
				dragListener.onDragExit(this, source, x, y, xOffset, yOffset,
						dragView, dragInfo);
			}
		}
	}
	...
	public boolean acceptDrop(DragSource source, int x, int y, int xOffset,
		...
		if (!isEnabled())
			return false;
		if (dropListener != null) {
			return dropListener.acceptDrop(this, source, x, y, xOffset,
